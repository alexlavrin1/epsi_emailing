...
export default async function ApprovalsPage() {
  ...
  return <main className="dashboard-main" id="main-content">
    ...
    {!data.clientDraftsReady ? <section className="panel setup-panel"><MessageSquareText size={20} aria-hidden="true" /><div><strong>Client playbook approvals are ready to install</strong><p>Apply migration 030 to review client-success drafts.</p></div></section> : null}
