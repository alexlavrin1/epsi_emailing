...
-- ─────────────────────────────────────────────────────────────────────────────
-- crm_customers — canonical CRM identity and channel preferences
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- payment_recovery_cases — one current recovery lifecycle per Stripe invoice
-- ─────────────────────────────────────────────────────────────────────────────
...
-- ─────────────────────────────────────────────────────────────────────────────
-- payment_recovery_messages — idempotent channel jobs for a recovery case
-- ─────────────────────────────────────────────────────────────────────────────
